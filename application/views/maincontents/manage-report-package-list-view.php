...
<div class="content">
            ...
            <div class="container">
                ...
                <div class="row  page-titles">
                    ...
                    <div class="col-sm-12"><h3 class="text-themecolor m-b-0 m-t-0"><?php echo ucfirst($input_mode); ?> Report</h3>

                        <ol class="breadcrumb">

                            <li class="breadcrumb-item"><a href="<?php echo base_url();?>user/dashboard">Home</a></li>

                            <li class="breadcrumb-item active"><?php echo ucfirst($input_mode); ?> Report</li>
