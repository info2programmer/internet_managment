...
<div class="content">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12"><h4 class="page-title">Manage Zone</h4>
                        <ol class="breadcrumb">
                            <li><a href="<?php echo base_url();?>index.php/user/dashboard">Satellite TV Systems</a></li>
                            <li class="active">Manage Zone</li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="card-box">
                            ...
                            <table id="datatable" class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                    	<div class="col-sm-6 col-md-4 col-lg-3"><p><a href="<?php echo base_url();?>index.php/manage_zone/edit/<?php echo $row->id; ?>" title="Edit"><i class="md md-mode-edit"></i></a></p></div>
                                        <!--<div class="col-sm-6 col-md-4 col-lg-3"><p><a onclick="return confirm('Are you sure?')" href="<?php echo base_url();?>index.php/manage_zone/confirmDelete/<?php echo $row->id; ?>" title="Delete"><i class="md md-delete"></i></a></p></div>-->
                                    </td>                                    
                                </tr>
                                <?php } ?>
                                </tbody>
