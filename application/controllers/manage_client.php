...
class Manage_client extends CI_Controller {
...

	{
		...
		$select = 'box_details.*';
		//$conditions = array('box_details.client_foreign_id'=>$id,'pkg_payment.c_id'=>$id);
		$conditions = array('box_details.client_foreign_id'=>$id);
		//$join[0] = array('table'=>'pkg_payment','field'=>'c_id','table_master'=>'box_details','field_table_master'=>'client_foreign_id','type'=>'left');

		//$join[0] = array('table'=>'pkg_payment','field'=>'box_no','table_master'=>'box_details','field_table_master'=>'box_no','type'=>'left');

      	//$order_by[0]=array('field'=>'pkg_payment.id','type'=>'desc');

		$data['rows'] = $this->common_model->find_data($table,'array','',$conditions,$select);
...
$data['action'] = 'New';
	...
	public function renew_assign($c_id,$box)

	{
		...
		$conditions = array('c_id'=>$c_id,'box_no'=>$box);
