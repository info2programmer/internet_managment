...
class Manage_zone extends CI_Controller {
	...
	{	
		...
		$data['maincontent']=$this->load->view('maincontents/manage-zone-list-view',$data,true);
	...
	function add()
	{
		$data['action'] = 'Add';
					...
					else
					{
						...
						if($success)
						{	
							$this->session->set_flashdata('success_message','Zone successfully inserted');	
		...
		$data['left_sidebar'] = $this->load->view('elements/left-sidebar','',true);
		$data['footer'] = $this->load->view('elements/footer','',true);
		$data['maincontent']=$this->load->view('maincontents/add-edit-zone-view',$data,true);
		$this->load->view('layout_after_login',$data);
	}
	######################################################################################
